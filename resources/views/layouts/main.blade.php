    ...
    <div class="flex h-screen flex-col justify-between font-sans">
        <header class="flex items-center justify-between py-10">
            ...
            <div class="flex items-center space-x-4 leading-5 sm:space-x-6">
                <a href="" class="font-medium text-gray-900  sm:block">
                    Articles
                </a>

                <a href="{{ route('categories') }}" class="font-medium text-gray-900  sm:block">
                    Categories
                </a>

                @auth
                    <a href="{{ url('/dashboard') }}" class="font-medium text-gray-900  sm:block">
                        Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}" class="font-medium text-gray-900  sm:block">
                        Login
                    </a>

                    <a href="{{ route('register') }}" class="font-medium text-gray-900  sm:block">
                        Register
                    </a>
                @endauth
            </div>
        ...
        <footer>
            <div class="mt-16 flex flex-col items-center">
                <div class="mb-3 flex space-x-4">
                    <a class="text-sm text-gray-500 transition hover:text-gray-600"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                           ...
                           rel="noopener noreferrer" href="https://twitter.com/Twitter"><span
                ...
                <div class="mb-2 flex space-x-2 text-sm text-gray-500 dark:text-gray-400">
                    <div>@Masum Rahman Hasan</div>
                    <div>•</div>
                    <div>2023</div>
                    <div>•</div>
                    <a href="">Masum Rahman hasan Articles</a>
                </div>
            </div>
        </footer>
